...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nearby — Book trusted local service pros" },
      { name: "description", content: "Find, book, and review vetted service providers near you: cleaning, plumbing, electrical, handyman, beauty, tutoring, pet care, and more." },
      { property: "og:title", content: "Nearby — Book trusted local service pros" },
      { property: "og:description", content: "Find, book, and review vetted service providers near you." },
